...
var getViewForSwagger2 = function (opts, type) {
    ...
    _.forEach(swagger.paths, function (api, path) {
        ...
        _.forEach(api, function (op, m) {
            ...
            method.okResponse = method.responses['200']
    ...
    data.enums = data.definitions.filter(function(x) {
        return x.tsType.isEnum;
    });
    data.definitions = data.definitions.filter(function(x) {
        return !x.tsType.isEnum;
    });
